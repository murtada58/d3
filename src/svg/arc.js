...
d3.svg.arc = function() {
  ...
  function arc() {
    ...
    if (Math.max(rc[0], rc[1], rc[2], rc[3]) > 1e-3) {
      cr = r0 < r1 ^ cw ? 0 : 1;
      ...
      if (x1 != null) {
        ...
        var t30 = d3_svg_arcCornerTangents(x3 == null ? [x2, y2] : [x3, y3], [x0, y0], r1, rc10, cw), // rc1 here controlls top left corner
            t12 = d3_svg_arcCornerTangents([x1, y1], [x2, y2], r1, rc11, cw); // rc1 here controlls top right corner
      ...
      if (x3 != null) {
        ...
        var t03 = d3_svg_arcCornerTangents([x0, y0], [x3, y3], r0, -rc00, cw), // rc0 here controlls bottom left corner
            t21 = d3_svg_arcCornerTangents([x2, y2], x1 == null ? [x0, y0] : [x1, y1], r0, -rc01, cw); // rc0 here controlls bottom right corner
